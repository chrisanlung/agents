...
import { checkInBooking, markComplete, markNoShow, cancelBooking } from "../actions";
                ...
                <>
                  ...
                  >
                    {isPending ? (
                      ...
                      <CheckCircle size={16} className="mr-1.5" aria-hidden="true" />
                    )}
                    Konfirmasi Check-in
                  </Button>
                  <Button
                  ...
                  >
                    <UserX size={16} className="mr-1.5" aria-hidden="true" />
                    Tandai Tidak Hadir
                  </Button>
                  <Button
                    variant="outline"
